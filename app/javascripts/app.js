...
import ecommerce_store_artifcts from '../../build/contracts/EcommerceStore.json'

var EcommerceStore = contract(ecommerce_store_artifcts)
...
function saveProductToBlockchain(params, imageId, descId) {
  ...
  EcommerceStore.deployed().then(function(i) {
    i.addProductToStore(params['product-name'], params['product-category'], imageId, descId, auctionStartTime,
      ...
      console.log('save to blockchain done')
      console.log(f)
      $('#msg').show()
